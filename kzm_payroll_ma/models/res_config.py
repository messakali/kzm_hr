...
class ResConfigSettings(models.TransientModel):
    ...
    journal_id = fields.Many2one('account.journal',related="company_id.journal_id", string=u'Journal')
    ...
    salary_debit_account_id = fields.Many2one('account.account', related="company_id.salary_debit_account_id",string=u'Compte de débit')
